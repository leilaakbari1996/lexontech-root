...
(() => {
  ...
  if (
    !localStorage.getItem("sashlayout") &&
    !localStorage.getItem("sashnavstyles") &&
    !localStorage.getItem("sashverticalstyles") &&
  ...
  function rtlFn() {
    ...
    document
      ...
      ?.setAttribute(
        "href",
        "/root/assets/libs/bootstrap/dist/css/bootstrap.rtl.min.css"
      );
    //RTL
