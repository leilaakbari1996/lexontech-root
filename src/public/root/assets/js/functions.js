...
{
    $.swal('error','لطفا فیلد ها راssss درست وارد کنید.','error',null,$.swalInfo)
...
$.swal = function (title,text,icon,url = null,swal = null,is_reload=true)
{
    Swal.fire({
        ...
        confirmButtonColor: swal.confirmButtonColor ,
...
$.swalDelete = function (title,text,icon,url = null,swal = null,is_reload=true)
{
    Swal.fire({
        title: title,
        text: text,
