        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade border-0 p-0" id="sidebar-slidepane-2" role="tabpanel" aria-labelledby="sidebar-side2" tabindex="0">
                ...
                <div class="d-flex align-items-center py-3 px-3 pt-0">
                    <div class="me-2">
                        <span class="avatar avatar-md avatar-rounded cover-image"  data-bs-image-src="{{TransferFacade::loadAsset('/root/assets/images/faces/2.jpg')}}"></span>
                    </div>
                    <div class="">
                        <a href="chat.html">
                ...
                <div class="d-flex align-items-center py-3 px-3 pt-0">
                    <div class="me-2">
                        <span class="avatar avatar-md online avatar-rounded cover-image"  data-bs-image-src="{{TransferFacade::loadAsset('/root/assets/images/faces/11.jpg')}}"></span>
                    </div>
                    <div class="">
                        <a href="chat.html">
                ...
                <div class="d-flex align-items-center py-3 px-3 pt-0">
                    <div class="me-2">
                        <span class="avatar avatar-md avatar-rounded cover-image"  data-bs-image-src="{{TransferFacade::loadAsset('/root/assets/images/faces/10.jpg')}}"></span>
                    </div>
                    <div class="">
                        <a href="chat.html">
                ...
                <div class="d-flex align-items-center py-3 px-3 pt-0">
                    <div class="me-2">
                        <span class="avatar avatar-md avatar-rounded cover-image"  data-bs-image-src="{{TransferFacade::loadAsset('/root/assets/images/faces/13.jpg')}}"></span>
                    </div>
                    <div class="">
                        <a href="chat.html">
                ...
                <div class="d-flex align-items-center py-3 px-3 pt-0">
                    <div class="me-2">
                        <span class="avatar avatar-md online avatar-rounded cover-image"  data-bs-image-src="{{TransferFacade::loadAsset('/root/assets/images/faces/12.jpg')}}"></span>
                    </div>
                    <div class="">
                        <a href="chat.html">
                ...
                <div class="d-flex align-items-center py-3 px-3 pt-0">
                    <div class="me-2">
                        <span class="avatar avatar-md avatar-rounded cover-image"  data-bs-image-src="{{TransferFacade::loadAsset('/root/assets/images/faces/15.jpg')}}"></span>
                    </div>
                    <div class="">
                        <a href="chat.html">
                ...
                <div class="d-flex align-items-center py-0 px-3">
                    <div class="me-2">
                        <span class="avatar avatar-md avatar-rounded cover-image"  data-bs-image-src="{{TransferFacade::loadAsset('/root/assets/images/faces/4.jpg')}}"></span>
                    </div>
                    <div class="">
                        <a href="chat.html">
                ...
                <div class="d-flex align-items-center py-3 px-3 pt-0">
                    <div class="me-2">
                        <span class="avatar avatar-md online avatar-rounded cover-image"  data-bs-image-src="{{TransferFacade::loadAsset('/root/assets/images/faces/7.jpg')}}"></span>
                    </div>
                    <div class="">
                        <a href="chat.html">
                ...
                <div class="d-flex align-items-center py-3 px-3 pt-0">
                    <div class="me-2">
                        <span class="avatar avatar-md avatar-rounded cover-image"  data-bs-image-src="{{TransferFacade::loadAsset('/root/assets/images/faces/9.jpg')}}"></span>
                    </div>
                    <div class="">
                        <a href="chat.html">
                ...
                <div class="d-flex align-items-center py-3 px-3 pt-0">
                    <div class="me-2">
                        <span class="avatar avatar-md online avatar-rounded cover-image"  data-bs-image-src="{{TransferFacade::loadAsset('/root/assets/images/faces/2.jpg')}}"></span>
                    </div>
                    <div class="">
                        <a href="chat.html">
                            <div class="fw-semibold text-dark">Addie Minstra</div>
                ...
                <div class="d-flex align-items-center py-3 px-3 pt-0">
                    <div class="me-2">
                        <span class="avatar avatar-md avatar-rounded cover-image"  data-bs-image-src="{{TransferFacade::loadAsset('/root/assets/images/faces/14.jpg')}}"></span>
                    </div>
                    <div class="">
                        <a href="chat.html">
                ...
                <div class="d-flex align-items-center py-3 px-3 pt-0">
                    <div class="me-2">
                        <span class="avatar avatar-md avatar-rounded cover-image"  data-bs-image-src="{{TransferFacade::loadAsset('/root/assets/images/faces/11.jpg')}}"></span>
                    </div>
                    <div class="">
                        <a href="chat.html">
